...
$productos = $_SESSION['datosproductosfecha'];

$inicio = $_SESSION['fechainicio'];
$fin = $_SESSION['fechafinal'];
$pdf->Cell(32, 10, 'Desde: ' . $inicio, 0, 0, 'C');
$pdf->Cell(70, 10, 'Hasta: ' . $fin, 0, 0, 'C');
$pdf->Ln();
...
if ($productos === true) {
    ...
    while ($result = mysql_fetch_array($consultaproductosactivos)) {
        ...
        $consulta = mysql_query("(SELECT fecha,tb_entradas.tipo,tr_productos_entradas.id_producto,cantidad,tb_entradas.factura,'entrada' "
                ...
                . "and tb_entradas.id_entrada=tr_productos_entradas.id_entrada and fecha between '$inicio' and '$fin') "
                . "UNION ALL (SELECT fecha,tb_salidas.tipo,tr_productos_salidas.id_producto,cantidad,tb_salidas.factura_salida,'salida' as tipom  "
                . "FROM tr_productos_salidas,tb_salidas WHERE id_producto=$id and tb_salidas.id_salida=tr_productos_salidas.id_salida "
                . "and fecha between '$inicio' and '$fin')   ORDER BY fecha asc");
