                                    ...
                                    while ($listajugadores = mysql_fetch_array($consulta)) {
                                        ...
                                        <tr class="default caja">
                                            ...
                                            <td>
                                                ...
                                                <?php $query=  mysql_fetch_array(mysql_query("SELECT tb_usuarios.nombre as nombre FROM `tb_productos`,tb_usuarios Where id_producto=$producto and proveedor=cc"));
                                                echo $query['nombre'];
                                                ?>                                                
                                    ...
                                    <form > 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 "> 
                                                ...
                                                <textarea class="form-control" rows="3" style="resize: inherit"></textarea>
                                            </div>
                            ...
                            $.ajax({
                                ...
                                success: function (resp) {
                                    ...
                                    if (resp.Salida === true && resp.Mensaje === true) {
                                        $('.nombre').val(resp.jugador.nombre);
                                        $('.valor').val(resp.jugador.valor);
                                        $('.descripcion').val(resp.jugador.descripcion);
